...
export const zh: Record<keyof typeof en, string> = {
  ...
  hero:'发现用 Jev 构建的项目。',intro:'查看源码、实际用途和使用条件。独立整理公开资料，帮助你找到值得进一步了解的项目。',projectsDescription:'浏览完整的 Jev Atlas 项目目录，并查看每个项目的源码状态、生态关系、使用条件和资料核查日期。',searchDescription:'按名称、用途、标签或作者搜索 Jev 项目，再根据生态关系、源码状态和使用条件缩小范围。',aboutDescription:'了解 Jev Atlas 如何独立发现、核查、分类、翻译并维护 Jev 项目的公开资料。',privacyDescription:'了解 Jev Atlas 如何处理公开项目资料、本地搜索、联系草稿、访问分析、外部链接和隐私选择。',independent:'独立目录，与 TypeSafe AI 无隶属关系。',official:'Jev 官方网站',
